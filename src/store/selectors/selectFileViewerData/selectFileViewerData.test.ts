...
it('should return a tree or should convert a list of user files to the file viewer structure', () => {
  const userFiles: FilesState['userFiles'] = [
    {
      id: '1',
      name: 'index1.js',
  ...
  const expectedResult: FileViewerStructure = {
